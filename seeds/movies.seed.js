//! 0.) Usar el modelo que deberemos conectar con la BBDD. Esto podría ser realizado en un JSON a parte, pero lo declaramos como constante y lo ponemos en el seed.
...
// mongoose.connect();
// Si no hubieramos declarado en la carpeta db lo de arriba, pondríamos las líneas de arriba. Como ya lo hemos hecho, solo necesitaremos invocar la función de más abajo.

require("../db");

//! 2.) Usar las herramientas que nos permiten acceder a la BBDD
//? En este caso no tenemos el array en un JSON, sino aquí declarado como una constante. Pero el Model sí que hay que requerirlo.
...
async function addMovies() {
  try {
    ...
    // De aquí en adelante es lo que ocurre una vez la promesa de arriba ha sido resuelta.
    console.log("Las películas fueron agregadas.");
  } catch (err) {
    console.log("Algo ha ocurrido: ", err);
  }
}
